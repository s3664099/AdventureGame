...
public class Data_Process {
	...
	public Data_Process() {
		...
		start.addExit(new Exit("Storeroom Door","storeroom door",fifteen,true,true,false));
		...
		seven.addExit(new Exit("Hung, Drawn & Quartered","pub hung drawn quartered",eight,false,false,false));
		eight.addExit(new Exit("North",seven,false,false,true));
		nine.addExit(new Exit("South",six,false,false,true));
		nine.addExit(new Exit("Tower Hill Station","tower hill station",ten,false,false,true));
		...
		twelve.addExit(new Exit("Toilet Door","toilet door",sixteen,false,true,false));
		thirteen.addExit(new Exit("East",eleven,false,false,true));
		thirteen.addExit(new Exit("Cheshire Cheese","cheshire cheese pub",fourteen,false,false,true));
