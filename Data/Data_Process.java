...
public class Data_Process {
	...
	public Data_Process() {
		...
		three.addExit(new Exit("the Minories",start,false,false,false));
		...
		seven.addExit(new Exit("Hung, Drawn & Quartered",eight,false,false,false));
		eight.addExit(new Exit("North",seven,false,false,true));
		nine.addExit(new Exit("South",six,false,false,true));
		nine.addExit(new Exit("Tower Hill Station",ten,false,false,true));
